...
const formatdate = (textvalue) => {
  const date = new Date(textvalue);
  return date.toLocaleDateString("en-US", { day: "2-digit", month: "short", year: "numeric" });
};
const stringformatter = (textvalue) => {
  return textvalue.replace(/&#(\d+);/g, (m, d) => String.fromCharCode(d));
};
const striphtmltags = (textvalue) => {
...
export { APP_BLOG as A, BLOG_BASE as B, CATEGORY_BASE as C, I18N as I, METADATA as M, POST_PERMALINK_PATTERN as P, SITE as S, TAG_BASE as T, UI as U, getPermalink as a, striphtmltags as b, getBlogPermalink as c, getCanonical as d, getFormattedDate as e, formatdate as f, getHomePermalink as g, cleanSlug as h, getAsset as i, stringformatter as s, trimSlash as t };
