...
import { $ as $$Features } from '../chunks/Features_Cw4zvcsN.mjs';
import { $ as $$Features2 } from '../chunks/Features2_siJZgs3-.mjs';
import { $ as $$Steps } from '../chunks/Steps_DkdbK91u.mjs';
import { $ as $$Content } from '../chunks/Content_C8MK9Lzp.mjs';
import { $ as $$BlogLatestPosts } from '../chunks/BlogLatestPosts_Qt3lMaH8.mjs';
import { $ as $$FAQs } from '../chunks/FAQs_MZfzwoqd.mjs';
import { $ as $$Stats } from '../chunks/Stats_D-w959fK.mjs';
...
const $$Index = createComponent(async ($$result, $$props, $$slots) => {
  ...
  Astro2.self = $$Index;
  const metadata = {
    title: "Kamal Gaur \u2014 Honing the ability to envision products that need building",
    ignoreTitleTemplate: true
  };
  return renderTemplate`${renderComponent($$result, "Layout", $$PageLayout, { "metadata": metadata }, { "default": ($$result2) => renderTemplate`      ${renderComponent($$result2, "Features2", $$Features2, { "title": "Real World", "subtitle": "Ideas that are meant for the <em>real</em> world", "tagline": "Idea Hub", "items": [
    {
      title: "1 Line Ideas",
  ...
  ] }, { "bg": ($$result3) => renderTemplate`${renderComponent($$result3, "Fragment", Fragment, { "slot": "bg" }, { "default": ($$result4) => renderTemplate` <div class="absolute inset-0 bg-blue-50 dark:bg-transparent"></div> ` })}` })} ${renderComponent($$result2, "Features", $$Features, { "id": "features", "tagline": "Features", "title": "What you get with AstroWind", "subtitle": "One of the most professional and comprehensive templates currently on the market. Most starred & forked Astro theme in 2022.", "items": [
    {
...
}, "C:/development/kamalgaur/astrowind/src/pages/index.astro", void 0);

const $$file = "C:/development/kamalgaur/astrowind/src/pages/index.astro";
const $$url = "";
